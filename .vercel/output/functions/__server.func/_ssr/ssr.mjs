...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B9a39cHC.mjs");
...
var manifest = {
	"3985e6ad82e720f744bbe6dbb68369fc16d5712e185d1215402890227d15df9b": {
		functionName: "decideActions_createServerFn_handler",
		importer: () => import("./ai-B_l6-LZb.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-1SVrWSLR.mjs").then((n) => n.t),
